...
async def upload_image(
    ...
    "- **Findings** – A clear and itemized summary of all observed image features, including measurements, densities, anomalies, and any regions of interest. Incorporate the patient's metadata (age, gender, symptoms, body part, and x-ray type) when relevant to interpreting the image. "
