...
metadata = user_meta
    ...
    "You will be given a patient's metadata followed by an X-ray image. "
    "Using both, write one long, professional, and detailed diagnostic report as if dictated for a clinical chart. "
